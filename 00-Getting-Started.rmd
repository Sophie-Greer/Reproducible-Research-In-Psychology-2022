---
title: "R Workshop 00-Getting-Started"
output: html_document
---

```{r setup}
#If needed, install all packages used in the "R for Data Science" workshop
install.packages("babynames", "fivethirtyeight", "formatR", "gapminder", "hexbin", "mgcv", "maps", "mapproj", "nycflights13", "rmarkdown", "skimr", "tidyverse", "viridis")
